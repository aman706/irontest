...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import IronRobo.events

        path = Path(f"IronRobo/modules/{shortname}.py")
        ...
        mod.IronRobo = IronRobo
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["IronRobo.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "IronRobo/modules/*.py"
