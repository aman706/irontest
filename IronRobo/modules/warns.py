...
from IronRobo.modules.helper_funcs.string_handling import split_quotes
from IronRobo.modules.log_channel import loggable
from IronRobo.modules.sql import warns_sql as sql
...
from IronRobo.modules.sql.approve_sql import is_approved
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Ironman's sticker
        keyboard = None
        log_reason = (
