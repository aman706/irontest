...
from IronRobo.helper_extra.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)

from IronRobo.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from IronRobo.modules.log_channel import loggable
from IronRobo.modules.helper_funcs.alternate import send_message
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text("I can't promote someone who isn't in the group.Check again.")
        else:
